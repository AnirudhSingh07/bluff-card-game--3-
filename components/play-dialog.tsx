...
const allowedCardTypes = lastClaim
  ...
  return (
    <div className="relative flex w-130 ">
      <Card className="w-200 max-w-2xl shadow-xl max-h-[90vh] overflow-y-auto p-4 sm:p-6 flex flex-col">
        ...
        {/* Player hand */}
        <div className="relative flex-1 flex items-center justify-center min-h-[250px] min-w-[250px] sm:min-h-[260px]">
  <PlayerHand
    cards={playerHand}
    selectable={true}
